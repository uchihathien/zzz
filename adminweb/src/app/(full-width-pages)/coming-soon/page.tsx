...
export const metadata: Metadata = {
  title: "Next.js Coming Soon Page | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Coming Soon page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
