...
export const metadata: Metadata = {
  title: "Next.js Inbox Details | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Inbox Details page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
