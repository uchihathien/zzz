...
export const metadata: Metadata = {
  title: "Next.js Support Reply | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Support Reply for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
