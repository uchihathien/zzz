...
export const metadata: Metadata = {
  title: "Next.js Support List | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Support List for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
