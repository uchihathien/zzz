...
export const metadata: Metadata = {
  title:
    "Next.js AI Text Generator | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is AI Next.js Text Generator page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
