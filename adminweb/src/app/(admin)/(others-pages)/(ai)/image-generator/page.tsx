...
export const metadata: Metadata = {
  title:
    "Next.js AI Image Generator | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is  Next.js AI Image Generator page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
