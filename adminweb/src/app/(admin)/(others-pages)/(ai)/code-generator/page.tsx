...
export const metadata: Metadata = {
  title:
    "Next.js AI Code Generator | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js AI Code Generator page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
