...
export const metadata: Metadata = {
  title:
    "Next.js Integrations Page | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Integrations page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
