...
export const metadata: Metadata = {
  title: "Next.js FileManager Page | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js FileManager page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
