...
export const metadata: Metadata = {
  title: "Next.js Form Layout | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Form Layout page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
