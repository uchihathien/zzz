...
export const metadata: Metadata = {
  title: "Next.js Advanced Data Table | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Advanced Data Table page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
