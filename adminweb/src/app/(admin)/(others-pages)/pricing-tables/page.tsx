...
export const metadata: Metadata = {
  title: "Next.js Pricing Table | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Pricing Table page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
