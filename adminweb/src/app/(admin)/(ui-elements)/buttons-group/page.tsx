...
export const metadata: Metadata = {
  title: "Next.js Button Groups | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Button Groups page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
