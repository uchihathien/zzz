...
export const metadata: Metadata = {
  title: "Next.js Breadcrumbs | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Breadcrumbs page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
