...
export const metadata: Metadata = {
  title: "Next.js CRM Dashboard | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js CRM Dashboard page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
