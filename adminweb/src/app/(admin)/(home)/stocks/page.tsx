...
export const metadata: Metadata = {
  title: "Next.js Stocks Dashboard | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js Stocks Dashboard page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
