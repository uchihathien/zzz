...
export const metadata: Metadata = {
  title: "Next.js Logistics Dashboard | Getabec - Next.js Dashboard Template",
  description:
    "This is Next.js  Logistics Dashboard for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
