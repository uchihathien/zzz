...
export const metadata: Metadata = {
  title:
    "Next.js Marketing Dashboard | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js Marketing Dashboard page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
