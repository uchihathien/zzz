...
export const metadata: Metadata = {
  title:
    "Next.js SaaS Dashboard | Getabec - Next.js Admin Dashboard Template",
  description:
    "This is Next.js SaaS Dashboard page for Getabec - Next.js Tailwind CSS Admin Dashboard Template",
};
